-- Criar nova função para o plano de dieta atualizado
CREATE OR REPLACE FUNCTION public.create_new_meal_plan(plan_date date, user_uuid uuid)
RETURNS void
LANGUAGE plpgsql
SECURITY DEFINER
...
-- Executar a função para criar o plano de hoje para o usuário
SELECT public.create_new_meal_plan(CURRENT_DATE, '16137f11-3d50-4fbf-9b64-c3282ec01cc2');